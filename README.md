...
2. Clone the repo
   ```sh
   git clone https://github.com/MiguelBarrios/snippet-tree.git
   ```
...
See the [open issues](https://github.com/MiguelBarrios/snippet-tree/issues) for a full list of proposed features (and known issues).
...
Your Name - [@twitter_handle](https://twitter.com/twitter_handle) - miguelbarriosdavila@gmail.com@miguelbarriosdavila@gmail.com_client.com
